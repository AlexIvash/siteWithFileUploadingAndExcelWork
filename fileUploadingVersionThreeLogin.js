    ...
    if(req.files){
        ...
        file.mv('./uploads/'+fileName, function (err) {
            if (err) {
                 ...
                 * TODO: В этой версии бе Mysql тоже реализовано криво, потому что берется файл имя которого захардкожено изначально
                 * TODO: pathToFile который передваем в workOnFile функцию всегда равен excelAutomation.xlsx - и это неправильно
